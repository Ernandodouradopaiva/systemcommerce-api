...
public final class PurchaseQuotationSpecifications {

    private PurchaseQuotationSpecifications() {}

    public static Specification<PurchaseQuotation> withFilters(
        ...
        return (root, query, cb) -> {
            ...
            if (StringUtils.hasText(search)) {
                ...
                predicates.add(cb.like(cb.lower(root.get("quotationNumber")), pattern));
            }
